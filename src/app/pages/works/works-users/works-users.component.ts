...
import { User } from 'src/shared/interfaces/interfaces-user';

@Component({
  selector: 'app-works-users',
  templateUrl: './works-users.component.html',
  styleUrls: ['./works-users.component.scss']
})
export class WorksUsersComponent implements OnInit {
